...
function InterviewForm() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Mock Interview Form</h1>
      <form onSubmit={handleSubmit}>
        {step === 1 && (
          <div className="mb-4">
            ...
            <input
              ...
              required
            />
            <button type="button" onClick={handleNext} className="mt-4 px-4 py-2 bg-blue-500 text-white rounded">Next</button>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="mb-4">
            <label htmlFor="projects" className="block text-lg font-medium mb-2">Projects:</label>
            <textarea
              id="projects"
              name="projects"
              rows="4"
              ...
              required
            />
            <label htmlFor="jobPosition" className="block text-lg font-medium mb-2">Job Position:</label>
            <input
              type="text"
              id="jobPosition"
              name="jobPosition"
